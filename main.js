...
// pause flag for overlay messages
let paused = false
// message step tracker
let messageStep = 0
//background
bg = {
...
bird = {
    ...
    render: function() {
        ...
        //apply pink hue filter to yellow bird sprite
        ctx.filter = 'hue-rotate(280deg) saturate(1.1)'
...
function showNextMessage() {
    ...
    if (messageStep === 1) {
        ...
        document.getElementById("askOutBtn").style.display = "block";
    }
}

// askOutBtn: hide overlay and resume game
const askOutBtn = document.getElementById('askOutBtn')
if (askOutBtn) {
    askOutBtn.addEventListener('click', function() {
        const messageBox = document.getElementById("messageBox");
        messageBox.style.display = "none";
        document.getElementById("askOutBtn").style.display = "none";
        document.getElementById("nextBtn").style.display = "none";
        // resume gameplay
        paused = false
    })
...
let update = () => {
    // if paused for a message overlay, skip updates
    if (paused) return
